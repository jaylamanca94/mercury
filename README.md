...
Version **0.0.9** — Session changes immediately hide private content and reload into the current identity; routine token refresh preserves drafts. Current Acadia disclosures and bounded dialog spacing remain readable at enlarged phone text sizes. Pre-1.0 acceptance gates remain below.
