...
Mercury is a private personal-finance workspace. Home is the active daily briefing: it presents the owner's net worth, portfolio-only selected-period change, estimated annual growth when live coverage is complete, annual dividends, authentic daily history, and a four-asset preview. Portfolio is the source-of-truth holdings workspace, with its own search, filters, sorting, quick add, and matching Cards or Table views for investments; property remains card-based. Income is a planning view for expected recurring gross income, live portfolio dividend estimates, and monthly category-level spending limits; it does not represent bank-confirmed activity or track individual expenses. Plan is a single illustrative Base plan that projects portfolio value and projected portfolio income from current holdings, recurring investment amounts, and its own saved assumptions.
