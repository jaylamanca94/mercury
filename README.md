...
Version **0.1.1** — Plan now combines a live portfolio projection, year selection, four statistics, source-linked cash-flow controls, saved retirement/contribution ages and current asset summaries. Date of birth now anchors accurate ages and birthday milestones. Pre-1.0 acceptance gates remain below.
