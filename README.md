...
Version **0.0.7** — Portfolio implements Figma frame `110:7662`: investment cards with daily market-price charts, recurring schedule summaries and compact property purchase-price/gain details. Home's wide-chart layout remains available. The product remains pre-1.0 until the documented authentication, migration and device acceptance gates pass.
