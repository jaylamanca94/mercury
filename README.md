...
Two summary cards show current all-investment value and **recorded investment-account value change including deposits and withdrawals**, selected by the shared 1W/1M/6M/1Y control. Existing deduplicated daily snapshots supply the first/last values and actual dates; the range ends at the latest recorded date. Summaries are independent of group/search/sort and Cards/Table. Search/sort live in the page ellipsis; compact group/period disclosures preserve responsive keyboard and touch access. Current group value and count still appear when a group is selected.
