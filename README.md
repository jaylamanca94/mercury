...
Version **0.0.5** — asset detail leads with daily market-price history, separate from your holding value. Property purchase prices and gain/loss remain available. The product remains pre-1.0 until the documented authentication, migration and device acceptance gates pass.
