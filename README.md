...
Version **0.0.8** — Income implements Figma section `129:4938` across desktop, tablet and phone, with four summary cards, compact Dividends and editable source Amount/Frequency. Explicit Save/Cancel protects drafts and summaries use confirmed saved values. The product remains pre-1.0 until the documented authentication, migration and device acceptance gates pass.
