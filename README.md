...
Version **0.2.1** — Plan now combines a live portfolio projection, year selection, four statistics, source-linked cash-flow controls, saved retirement/contribution ages and current asset summaries. Date of birth anchors accurate ages and birthday milestones. Property location now supplies a sourced appreciation assumption, and Plan includes projected property equity. Pre-1.0 acceptance gates remain below.
