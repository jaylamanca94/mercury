...
- `acadia-card-trend.mjs` — unchanged Acadia curve utility from published `686c30d3400a7d71554a8e50e09b6a54a8b6aa1a`, with per-file provenance in `acadia-vendor.json`. Home imports it through its module entry point; the existing stylesheet pin is unchanged.
