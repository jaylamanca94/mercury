...
Version **0.2.15** — Financial figures now distinguish current records, market-price movement, historical illustrations and Plan projections. Exact values and calculations are reachable by touch and keyboard. Portfolio preserves compatible Home periods and the Cards/Table return journey; edits show before/after previews while retaining confirmed-save protections. See [financial UX delivery](automation/financial-ux/2026-09-23/review.md).
