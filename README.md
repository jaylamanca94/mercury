...
Version **0.1.0** — Plan now combines a live portfolio projection, year selection, four statistics, source-linked cash-flow controls, saved retirement/contribution ages and current asset summaries. Pre-1.0 acceptance gates remain below.
