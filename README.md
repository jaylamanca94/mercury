...
Version **0.0.4** — optional property purchase prices with dollar and percentage gain/loss. The product remains pre-1.0 until the documented authentication, migration and device acceptance gates pass.
