...
Version **0.0.1** — first tracked semantic version; a patch for recovery and reliability. Earlier commits were unversioned. The product remains pre-1.0 until the documented remote, migration and device acceptance gates pass.
