...
Version **0.0.2** — Plan recovery, revision-aware settings saves and responsive Acadia refinements. The product remains pre-1.0 until the documented authentication, migration and device acceptance gates pass.
