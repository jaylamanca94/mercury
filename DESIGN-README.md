...
- One shared 1W/1M/6M/1Y selector (default 1W) controls card market histories. Footer order is period, signed percentage, signed USD change **per share/unit**, never a gain based on the owner’s share count or purchase cost. Use the first and last observed daily prices within the selected calendar range; accessible text includes provider, actual dates and the exclusion of dividends/personal gain. Normal dollar changes show cents; sub-cent changes retain up to eight decimal places. Visible context: “Price change per share/unit · Allocation of total net worth.”
