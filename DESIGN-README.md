...
- Home's chart-height token is 244px on desktop/tablet and 169px on phone. Preserve actual date/value endpoints, investment-only scope, daily ranges and All, accessible history descriptions and one-point/empty states. The reference's benchmark, net-worth delta, native OS status bar and tablet placeholder route names are not implemented as invented data or navigation. Existing real routes and safe-area dock remain. Accurate labels are Expected annual growth and Annual dividends. Routine estimate explanations are accessible descriptions/tooltips; incomplete/loading explanations remain visible. Day and All-time signed amounts/absolute percentages retain the founder's signed-format contract.
