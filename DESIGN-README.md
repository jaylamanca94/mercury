...
- Use a compact content card below 30 distinct daily snapshots with one “History building · N of 30 days” message. At 30 dates, show the existing Acadia Card Trend within the naturally sized content card (avoid the fixed-height Dashboard Trend modifier with the expanded metric header) with timestamp-proportional spacing and an accessible dated description. Duplicate dates never advance the gate. Do not invent history or benchmark series.
