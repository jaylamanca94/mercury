...
Delivery receipt is recorded after the authorised Git-triggered production deployment. The previous Mercury revision remains the rollback source; no data migration is needed.
