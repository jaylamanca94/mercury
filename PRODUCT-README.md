...
Current: **0.2.16** — Home balance simplification above.
...
- Home answers “What are my investments worth, and how has that value changed?” with the exact current investment value, one observed history graph and YTD/1Y/All changes. Its collapsed calculation detail preserves net worth, property equity, day/lifetime change, historical growth illustration and estimated annual dividends. Four portfolio groups open the appropriate Portfolio destination. Investment value change includes cash flows; it is not investment return. See the Home balance contract above for coverage and freshness states.
