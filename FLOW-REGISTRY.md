...
> **Canonical flows: initial inventory pending — do not interpret as zero**

**Registry status:** Initial audit pending
**Last reviewed:** 2026-08-07

This is Mercury's authoritative record of canonical end-to-end user flows. Complete the first audit from the product brief, current routes, and tests before the next behavior-changing feature.
