...
| Understand current Brokerage position | Implemented; Home refinement reviewed 2026-09-04. | Home → scan current Net worth (investments + property equity), portfolio-only selected-period movement and history, prior-close movement, and annual estimates → open one of the four highest-value assets or View portfolio. Ranked rows combine holdings and property equity. Acadia supplies navigation, range tabs, cards, muted panels and responsive shell. | Empty; private loaded; unavailable property equity; fewer than two snapshots; partial annual metrics; long asset names; keyboard range selection; mobile and desktop. | 101 automated checks; isolated populated browser review in light/dark, 320/390/768/1024/1440px widths; keyboard range selection, asset navigation and property-dialog checks. Production account data and deployment were not part of this refinement verification. |
