...
| Manage holdings in Portfolio | Refined 2026-09-05. | Portfolio → investment value → search/filter/sort → Cards or Table → asset detail; optional allocation disclosure; recurring/property context below. Revisit → Cards. | Empty; clear no matches; overlapping Crypto/Retirement; missing valuation remains editable; native sorting in mobile Table; retained filters; adaptive cards; phone property dialogs. | 128 passing checks, including four added behaviour regressions; isolated browser checks at 1920/1440/1024/768/390/320px. See `automation/research/portfolio-2026-09-05.md`. |
