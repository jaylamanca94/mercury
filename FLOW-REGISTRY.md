...
| Manage holdings in Portfolio | Refined 2026-09-08. | Portfolio → investment value → investment group sidebar (compact selector on tablet/phone) → search/sort → Cards or Table → asset detail; optional allocation disclosure; grouped recurring/property context below. Recurring Edit → Contribution. Revisit → Cards. | Empty; clear no matches; mutually exclusive Brokerage/Retirement/Crypto; unfiltered group values/counts/shares; retirement crypto counted only in Retirement; incomplete totals/shares withheld; missing valuation remains editable; native sorting in mobile Table; retained filters; two-column cards (three on wide desktop) and paired context on tablet/desktop, stacked on phones; focus restoration; phone property dialogs. | 161 passing tests including group reconciliation and exclusive filters; local light/dark Cards/Table at 2560/1920/1440/1024/768/390/320px, keyboard selection, entry/return focus and incomplete/zero/empty states. See `automation/design/2026-09-08/investment-groups.md`. |
