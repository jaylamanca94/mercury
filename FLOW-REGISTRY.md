...
| Understand current position | Implemented; Property-inclusive Home 0.2.17. | Home → exact net worth including property equity → YTD/1Y/All graph and value change → optional Values and calculations → Brokerage, Crypto, Retirement or Property → scoped Portfolio. | Zero/one/many observations; incomplete range; same-day current endpoint; missing valuation; zero/negative baseline; stale saved prices; missing property; legacy investment-only snapshots; keyboard periods; responsive/enlarged text. | Calculation/controller checks and isolated synthetic browser evidence in [Home balance validation](automation/home-balance/2026-09-23/review.md). |
| Manage holdings in Portfolio | Refined 2026-09-16. | Portfolio → select investment group → automatic descending holding-value order → Cards or Table → asset detail. Unvalued assets last; no investment search/manual-sort controls. Ordinary revisit → Cards; Asset Back → originating Cards/Table view, group, period, focus and scroll. | Group and period continuity; empty-group View all recovery with picker focus; missing valuation repair; value changes automatically reorder both views; keyboard asset entry and return. | 266 passing checks and synthetic desktop/320px Cards/Table verification; see `automation/portfolio-value-order/2026-09-16/review.md`. |
...
- Product-schema rebuild and migration-history parity verified on 2026-09-22 (0.2.8); hosted anonymous and two-user table isolation passed on 2026-09-21 (0.2.7). A synthetic eight-table product-data backup/restore drill also passed on 2026-09-22; see `supabase/RECOVERY.md`. Hosted backup inspection on 2026-09-22 confirms seven completed daily backups and PITR off; the isolated hosted restore awaits explicit approval of the quoted paid project/full-data copy. Hosted services and real owner-data recovery remain unproven; see `automation/review/2026-09-22/hosted-recovery/review.md`.
...
## Home weighted market chart — 2026-09-22
...
## Financial-information interaction verification — 2026-09-23

The existing ten-flow summary is unchanged. Version 0.2.15 adds exact-value/calculation disclosures, explicit annual/scope/unit labels, compatible Home-to-Portfolio periods, Asset Back context restoration and inline before/after previews to the flows above. Plan explicitly separates current holdings from dated projections and saved settings from drafts. The original confirmation, conflict, timeout and account-isolation contracts remain in force. Validation and remaining device/owner acceptance boundaries: [financial UX review](automation/financial-ux/2026-09-23/review.md).

## Home balance simplification — 2026-09-23

The ten canonical flows remain unchanged. 0.2.16 removes Home's market/recorded mode choice and four summary cards in favour of one exact investment balance, matching observed value history and selected-period changes. Secondary values move to one disclosure. Tests cover boundary/partial dates, deduplication/current replacement without writes, price timestamps, cash-flow-inclusive arithmetic, zero/missing values, keyboard range changes and Portfolio measure handoff. [Evidence](automation/home-balance/2026-09-23/review.md).

## Property-inclusive Home — 2026-09-23

0.2.17 includes property equity in Home's total and historical comparison. Future daily snapshots record both components; legacy investment-only records remain unchanged and are omitted from net-worth comparisons. Includes coverage for negative equity/net worth, legacy null versus recorded zero, missing current property data, safe integer limits and complete snapshot writes. Ten canonical flows remain. [Validation](automation/home-net-worth/2026-09-23/review.md).
