...
test("Home consumes canonical Acadia components with documented composition adapters", () => {
  assert.match(styles, /^@import url\("acadia\.css\?v=20260918-2b80572"\);/);
...
test("Plan provides one hero projection, four statistics and live scenario controls", () => {
  ...
  assert.match(indexHtml, /<script type="module" src="brokerage\.js\?v=20260918-editor-revisions"><\/script>/);
