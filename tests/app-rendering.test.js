...
test("Plan provides one hero projection, four statistics and live scenario controls", () => {
  ...
  assert.match(indexHtml, /<script src="plan\.js\?v=20260914-day-change-022"><\/script>/);
  assert.match(indexHtml, /<script type="module" src="brokerage\.js\?v=20260914-day-change-022"><\/script>/);
